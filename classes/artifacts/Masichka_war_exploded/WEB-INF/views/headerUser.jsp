			...
			<div class="container">
				...
				<sec:authorize access="hasRole('USER')">
					<div class="collapse navbar-collapse" id="navbarResponsive">
						<ul class="navbar-nav text-uppercase ml-auto">
							...
							<li class="nav-item">
								<a class="nav-link js-scroll-trigger" href="<c:url value="/profile" />"><i class="fa fa-wrench" aria-hidden="true"></i>&nbsp;Промяна профил</a>
							</li>
                            <li class="nav-item">
                ...
                <sec:authorize access="hasRole('ADMIN')">
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav text-uppercase ml-auto">
                            <li class="nav-item">
                                <a class="nav-link js-scroll-trigger" href="<c:url value="/addplace" />"><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp;Добави ресторант</a>
                            </li>
							<li class="nav-item">
