    ...
    <form:form method="POST" modelAttribute="place" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:select path="setups" items="${setups}" multiple="false" itemValue="id" itemLabel="name" class="selectpicker" data-width="auto" />
                    <div class="has-error">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:select path="region" items="${regions}" multiple="false" itemValue="id" itemLabel="name" class="selectpicker" data-width="auto" />
                    <div class="has-error">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:select path="avgBill" items="${avgBills}" multiple="false" itemValue="id" itemLabel="name" class="selectpicker" data-width="auto" />
                    <div class="has-error">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:select path="payMethods" items="${payMethods}" multiple="true" itemValue="id" itemLabel="name" class="selectpicker" data-width="auto" />
                    <div class="has-error">
