...
<header class="masthead">
    ...
    <div class="container">
        ...
        <div class="intro-text">
            <div class="intro-lead-in">РЕЗЕРВИРАЙ МАСА В <br/><a class="navbar-brand js-scroll-trigger"
                                                                 href="#page-top"><img
                    src="/static/img/Masichka.png" alt=""></a><br/>С ДО <span
                    style="color: #ff4852"> 50% ОТСТЪПКА</span></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading text-uppercase">Може да изберете от следните<br/></h2>

                    <ul id="myTab" class="nav nav-tabs text-center">
                        &nbsp;&nbsp;
                        <li><a href="#home" class="btn btn-primary btn-xl text-uppercase" data-toggle="tab"
                               aria-expanded="false">Ресторанти</a></li>
                        <h2>&nbsp; ИЛИ &nbsp;</h2>
                        <li><a href="#profile" class="btn btn-primary btn-xl text-uppercase" data-toggle="tab"
                               aria-expanded="true">Клубове</a></li>
                    </ul>
        ...
        <div id="myTabContent" class="tab-content text-center">
            <%-- <div class="col-sm-12 text-center">
                 <ul id="myTab" class="nav nav-tabs text-center">
                     <li>
                     <a href="#home" class="btn btn-primary btn-xl text-uppercase"  data-toggle="tab" aria-expanded="false">Ресторанти</a></li>
                    <li> <a href="#profile" class="btn btn-primary btn-xl text-uppercase" data-toggle="tab" aria-expanded="true">Клубове</a></li>
                 </ul>
             </div>--%>
